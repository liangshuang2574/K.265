          ...
          <li>
            <div className='bg-[#31322C] rounded-[10px] flex mt-[14px]'>
              ...
              <div className='flex flex-col ml-[18px] pt-[20px]'>
                <span className='text-[#FDFCEE]'>{props.text2}</span>
                <span className='text-[#989895] text-[12px]'>{props.text3}</span>
              </div>
            </div>
            <div className='bg-[#31322C] rounded-[10px] flex mt-[14px]'>
              <img src={props.imageDetail2} className='w-[95px]'></img>
              <div className='flex flex-col ml-[18px] pt-[20px]'>
                <span className='text-[#FDFCEE]'>{props.text4}</span>
                <span className='text-[#989895] text-[12px]'>{props.text5}</span>
              </div>
            </div>
            <div className='bg-[#31322C] rounded-[10px] flex mt-[14px]'>
              <img src={props.imageDetail3} className='w-[95px]'></img>
              <div className='flex flex-col ml-[18px] pt-[20px]'>
                <span className='text-[#FDFCEE]'>{props.text6}</span>
                <span className='text-[#989895] text-[12px]'>{props.text7}</span>
              </div>
            </div>
          </li>
        </ul>
